...
const ModifiyListing = ({openModal, setOpenModal , annonce}) => {
...
const handleSubmit = async (e) => {
  ...
  try {
      await axios.put('/api/listings/'+annonce.ListingID, formData, { withCredentials: true }).then((res) => {
        setLoading(false);
          setSuccess(res.data);
          setError("")
          setOpenModal(false)
            ...
            <form className="p-4 md:p-5">
              <div className="grid gap-4 mb-4 grid-cols-2">
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <select
                  defaultValue={annonce?.CategoryID}
                  onChange={handelChange}
                    name="category"
                    id="catégorie"
                ...
                <div className="col-span-2">
                  ...
                  <select
                  defaultValue={annonce?.Location}
                  onChange={handelChange}
                  name="Location"
                    id="localisation"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  >
                    <option defaultChecked>Choisir une localisation</option>
